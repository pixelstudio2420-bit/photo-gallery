...
<article class="max-w-3xl mx-auto p-6">
    <a href="{{ route('announcements.index') }}"
       class="inline-flex items-center gap-2 text-sm text-slate-500 hover:text-pink-600 mb-4">
    ...
    @if($announcement->cta_label && $announcement->cta_url)
        <div class="mt-8">
            <a href="{{ $announcement->cta_url }}" target="_blank" rel="noopener"
               class="inline-flex items-center gap-2 px-6 py-3 rounded-xl bg-pink-600 hover:bg-pink-700 text-white font-bold transition">
