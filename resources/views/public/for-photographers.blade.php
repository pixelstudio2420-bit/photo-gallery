    ...
    <div class="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-12 items-center">
      ...
      <div class="lg:col-span-7 relative z-[1]">
        ...
        <p class="text-base sm:text-lg lg:text-xl text-slate-600 dark:text-slate-300 leading-relaxed mb-7 max-w-xl">
          ...
          AI ค้นหาใบหน้าระดับ enterprise และโอนเงินเข้าบัญชีไทยตามรอบเมื่อยอดถึงขั้นต่ำ
        </p>
    ...
    <div class="space-y-3" x-data="{ open: 0 }">
      @php
        ...
        $faqs = [
          ...
          ['q' => 'ระบบ AI ใช้อะไร? แม่นแค่ไหน?', 'a' => 'ระบบใช้ AI Face Recognition ระดับ enterprise (เกณฑ์การจับคู่เดียวกับที่ใช้ในงาน security ระดับโลก) เพื่อจับคู่ใบหน้า. ค่าเริ่มต้นใช้เกณฑ์ความเหมือน 80% (ปรับได้). ใส่หมวก / แว่น / มุมเฉียง โดยทั่วไปยังจับคู่ได้. ภาพ selfie ของลูกค้าไม่ถูกบันทึกลงระบบ — ใช้แล้วทิ้ง.'],
