      ...
      $sections = [
        ...
        'การชำระเงิน · คืนเงิน' => [
          [
            ...
            'a' => 'PromptPay QR Code (แนะนำ — เร็วที่สุด), บัตรเครดิต/เดบิต (Visa, MasterCard, JCB) ผ่าน Stripe และ Omise, โอนเงินผ่านธนาคาร (อนุมัติด้วยการอัปโหลดสลิป), True Wallet สำหรับยอดต่ำกว่า 1,000 บาท',
          ],
          [
            'q' => 'ใบกำกับภาษี / e-Tax Invoice มีให้ไหม?',
            'a' => 'มีครับ — กรอกเลขผู้เสียภาษี + ที่อยู่ตอน checkout ระบบออก e-Tax Invoice อัตโนมัติส่งเข้าอีเมล (ไฟล์ PDF + XML สำหรับยื่นภาษี)',
          ],
          [
        ...
        'ช่างภาพ · ขายภาพ' => [
          ...
          [
            ...
            'a' => 'ระบบจ่ายเงินอัตโนมัติเข้า PromptPay ของช่างภาพตามรอบที่แอดมินตั้งไว้ (ปกติทุกวันจันทร์ หรือทุกวันที่ 15) เมื่อยอดสะสมถึงขั้นต่ำ — ดูตารางจ่ายเงินจริงในหน้า "รายได้ของฉัน"',
          ],
          [
        ...
        'บัญชี · ความปลอดภัย' => [
          ...
          [
            ...
            'a' => 'รักษาตาม PDPA — ไฟล์ภาพเก็บใน Cloudflare R2 (เข้ารหัส at-rest), อัปโหลดผ่าน HTTPS, รหัสผ่าน hash ด้วย bcrypt, ใบหน้าใน face index ลบได้ตามคำขอ ไม่ขายข้อมูลให้ third party ใดๆ',
          ],
        ],
      ];
    @endphp
