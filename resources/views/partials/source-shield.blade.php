@if(!empty($sourceProtection) && !empty($sourceProtection['enabled']))
<style>
img {
  user-select: none;
...
(function () {
  ...
  var sp = {
    disableRightclick: {{ !empty($sourceProtection['sp_disable_rightclick']) ? 'true' : 'false' }},
    disableDevtools:  {{ !empty($sourceProtection['sp_disable_devtools'])  ? 'true' : 'false' }},
    disableViewsource: {{ !empty($sourceProtection['sp_disable_viewsource']) ? 'true' : 'false' }},
    disableCopy:    {{ !empty($sourceProtection['sp_disable_copy'])    ? 'true' : 'false' }},
    disableDrag:    {{ !empty($sourceProtection['sp_disable_drag'])    ? 'true' : 'false' }},
    consoleWarning:  {{ !empty($sourceProtection['sp_console_warning'])  ? 'true' : 'false' }}
  };
