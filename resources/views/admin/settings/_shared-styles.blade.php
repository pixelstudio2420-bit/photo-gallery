{{--
  Shared styles used across admin settings / system pages.
  Include once per page via: @include('admin.settings._shared-styles')
  Provides:
    - .tw-switch : Tailwind-friendly toggle switch (replaces Bootstrap form-switch)
    - .status-dot : status pill with leading dot (connected/disconnected/unknown)
    - .tw-spinner : small inline spinner
  All tokens respect dark mode through :root / .dark overrides.
--}}
<style>
/* ───────── Toggle switch ───────── */
.tw-switch {
