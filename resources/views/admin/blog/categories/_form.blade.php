{{-- Shared form partial for blog category create/edit --}}
            ...
            <div class="space-y-6">
                ...
                <div class="flex items-center gap-3">
                    ...
                    <button type="submit"
                        ...
                        <i class="bi bi-check-lg mr-1"></i>{{ $isEdit ? 'อัปเดต' : 'สร้างหมวดหมู่' }}
                    </button>
                </div>
            </div>
        </div>
...
function categoryForm() {
    return {
        ...
        selectedIcon: @json(old('icon', $category->icon ?? 'folder')),
        selectedColor: @json(old('color', $category->color ?? '#6366f1')),
