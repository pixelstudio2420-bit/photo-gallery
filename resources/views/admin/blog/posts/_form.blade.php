...
{{--
    All form-specific CSS (Tiptap toolbar/content + AI panel + form helpers)
    lives in resources/css/app.css now — the Tailwind v4 PostCSS plugin
    can't process @apply directives in inline <style> blocks pushed via
    @push/@stack at runtime. Moving the rules to app.css guarantees they
    end up in the compiled bundle.
--}}
