...
@section('title', 'แก้ไขลิงก์ Affiliate')
...
<div class="mb-6">
    <div class="flex items-center gap-3 mb-2">
        ...
        <h2 class="text-2xl font-bold text-slate-800 dark:text-white">
            <i class="bi bi-pencil-square text-purple-500 mr-2"></i>แก้ไขลิงก์ Affiliate
        </h2>
    </div>
    <p class="text-sm text-gray-500 dark:text-gray-400 ml-11">
        กำลังแก้ไข: <span class="font-medium text-slate-600 dark:text-gray-300">{{ $link->name }}</span>
    </p>
</div>

@include('admin.blog.affiliate._form', ['link' => $link])
@endsection
