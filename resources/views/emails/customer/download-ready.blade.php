@extends('emails.layout', ['title' => 'ภาพพร้อมดาวน์โหลด', 'preheader' => 'ดาวน์โหลดภาพของคุณได้แล้ว!'])
...
<div class="info-box highlight">
  ...
  <div class="info-row">
    ...
    <span class="value">{{ $photoCount ?? 0 }} ภาพ</span>
  </div>
  <div class="info-row">
    <span class="label">ลิงก์หมดอายุ</span>
    <span class="value" style="color:#ef4444;">{{ $expiresAt ?? now()->addDays(7)->format('d/m/Y H:i') }}</span>
  </div>
</div>

<div class="btn-wrap">
  <a href="{{ $downloadUrl }}" class="btn btn-success">📥 ดาวน์โหลดภาพทั้งหมด</a>
</div>
...
<p>ขอบคุณที่ไว้วางใจใช้บริการ <strong>{{ $siteName }}</strong>! ❤️</p>
@endsection
