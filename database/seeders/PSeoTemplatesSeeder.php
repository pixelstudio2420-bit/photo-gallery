    ...
    public function run(): void
    {
        $templates = [
            ...
            [
                ...
                'min_data_points'          => 1,
                'title_pattern'             => '{name} — ช่างภาพมืออาชีพ ผลงาน {event_count} งาน | {brand}',
                'meta_description_pattern' => '{name} ช่างภาพมืออาชีพบน {brand} — มีผลงาน {event_count} งานให้ดู รีวิวจากลูกค้า จองได้ทันที',
                'h1_pattern'               => '{name}',
                'body_template'            => "{name} เป็นช่างภาพมืออาชีพบน {brand} ที่มีผลงานคุณภาพรวม {event_count} งาน\n\n{bio}",
                'schema_type'              => 'Person',
                'linking_config'           => null,
            ],
            [
