...
<head>
  ...
  <title>เข้าสู่ระบบช่างภาพ · <?php echo e($siteName ?? config('app.name', 'Loadroop')); ?></title>
      ...
      <div class="grid grid-cols-1 lg:grid-cols-12 gap-6 lg:gap-10 items-stretch">
        ...
        <aside class="hidden lg:flex lg:col-span-6 xl:col-span-7 flex-col justify-center anim-in anim-in-1">
          ...
          <div class="inline-flex items-center gap-2 mb-5">
            ...
            <span class="text-strong font-extrabold text-lg tracking-tight"><?php echo e($siteName ?? config('app.name', 'Loadroop')); ?></span>
          </div>
        ...
        <main class="lg:col-span-6 xl:col-span-5 anim-in anim-in-2">
          <div class="lg-card rounded-3xl shadow-[0_30px_60px_-20px_rgba(0,0,0,0.5)]">
            <div class="p-6 sm:p-8">
              ...
              ?>
              <?php $__currentLoopData = $_flashes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $_key => $_meta): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <?php if(session($_key)): ?>
                  <div class="rounded-xl p-3 text-sm mb-3 anim-in anim-in-3 border"
                       style="background:rgba(<?php echo e($_meta['rgb']); ?>,0.12);
                              color:<?php echo e($_meta['text']); ?>;
                              border-color:rgba(<?php echo e($_meta['rgb']); ?>,0.30);">
                    <i class="bi bi-<?php echo e($_meta['icon']); ?> me-1"></i><?php echo e(session($_key)); ?>
              ...
              <div class="anim-in anim-in-4"
                   x-data="{ open: <?php echo e($errors->any() || old('email') ? 'true' : 'false'); ?> }">
                ...
                <div x-show="open" x-collapse class="mt-3">
                  <form method="POST" action="<?php echo e(route('photographer.login.post')); ?>" class="space-y-3">
                    <?php echo csrf_field(); ?>
                    ...
                    <div>
                      <div class="flex items-baseline justify-between mb-1.5">
                        ...
                        <a href="<?php echo e(route('photographer.password.request')); ?>"
              ...
              <div class="border-t mt-6 pt-4 text-center space-y-2 anim-in anim-in-4"
                ...
                <div class="text-sm">
                  ...
                  <a href="<?php echo e(route('photographer.register')); ?>" class="font-bold text-link transition ml-1">
                    สมัครเป็นช่างภาพ
                  </a>
                </div>
                <div>
                  <a href="<?php echo e(url('/')); ?>" class="text-[12px] text-faint hover:opacity-80 transition inline-flex items-center gap-1.5">
...
<?php /**PATH C:\xampp\htdocs\photo-gallery-pgsql\resources\views/photographer/auth/login.blade.php ENDPATH**/ ?>