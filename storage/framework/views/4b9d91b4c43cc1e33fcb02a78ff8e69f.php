...
<head>
  ...
  <title>Admin Login — <?php echo e($siteName ?? config('app.name')); ?></title>
    ...
    <div class="p-10 text-center">
      ...
      <?php if(session('logout_success')): ?>
        <div class="rounded-xl p-3 text-sm text-left mb-3" style="background:rgba(16,185,129,0.15);color:#6ee7b7;">
          <i class="bi bi-check-circle me-1"></i><?php echo e(session('logout_success')); ?>
      ...
      <form method="POST" action="<?php echo e(route('admin.login.post')); ?>" class="text-left">
        <?php echo csrf_field(); ?>
        <div class="mb-4">
          ...
          <div class="flex">
            ...
            <input type="email" name="email" class="w-full px-4 py-2.5 rounded-r-xl text-sm transition outline-none" style="background:rgba(255,255,255,0.06);border:1px solid rgba(255,255,255,0.1);border-left:none;color:#f1f5f9;" value="<?php echo e(old('email')); ?>" placeholder="admin@example.com" required autofocus>
          </div>
        </div>
        <div class="mb-4">
      ...
      <div class="mt-6">
        <a href="<?php echo e(url('/')); ?>" class="text-sm text-indigo-400 hover:text-indigo-300 transition">
...
<?php /**PATH C:\xampp\htdocs\photo-gallery-pgsql\resources\views/admin/auth/login.blade.php ENDPATH**/ ?>