...
<title><?php echo e($title ?? ($siteName ?? config('app.name'))); ?></title>
<style>
...
<div class="email-wrapper">
  ...
  <div class="email-header">
    ...
    <h1><?php echo e($siteName ?? config('app.name')); ?></h1>
    <?php if(!empty($title)): ?>
  ...
  <div class="email-footer">
    <p>
      <strong><?php echo e($siteName ?? config('app.name')); ?></strong><br>
      อีเมลนี้ถูกส่งโดยอัตโนมัติ กรุณาอย่าตอบกลับ
    </p>
    <?php if(!empty($supportEmail)): ?>
      <p>หากมีข้อสงสัย กรุณาติดต่อ <a href="mailto:<?php echo e($supportEmail); ?>"><?php echo e($supportEmail); ?></a></p>
    <?php endif; ?>
    <p>&copy; <?php echo e(date('Y')); ?> <?php echo e($siteName ?? config('app.name')); ?>. สงวนลิขสิทธิ์</p>
    <?php if(!empty($unsubscribeUrl)): ?>
      <p style="margin-top:10px;"><a href="<?php echo e($unsubscribeUrl); ?>" style="color:#9ca3af;font-size:11px;">ยกเลิกการรับอีเมล</a></p>
    <?php endif; ?>
  </div>
</div>
...
<?php /**PATH C:\xampp\htdocs\photo-gallery-pgsql\resources\views/emails/layout.blade.php ENDPATH**/ ?>