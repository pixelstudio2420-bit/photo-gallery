...
<head>
  ...
  <title><?php echo $__env->yieldContent('title', 'Dashboard'); ?> — Photographer | <?php echo e($siteName ?? config('app.name')); ?></title>
  <link rel="preconnect" href="https://fonts.googleapis.com">
  <link href="https://fonts.googleapis.com/css2?family=Sarabun:wght@300;400;500;600;700&display=swap" rel="stylesheet">
  <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/bootstrap-icons@1.11.3/font/bootstrap-icons.css">
  <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/sweetalert2@11/dist/sweetalert2.min.css">
  <?php echo app('Illuminate\Foundation\Vite')(['resources/css/app.css', 'resources/js/app.js']); ?>
  <link rel="stylesheet" href="<?php echo e(asset('css/photographer.css')); ?>">
...
<div id="photographer-wrapper">
    ...
    <div class="px-6 py-2 flex items-center justify-between flex-wrap gap-2">
      <div class="flex items-center gap-2 text-sm">
        ...
        <span>
          ...
          <strong><?php echo e(Auth::user()?->full_name ?? Auth::user()?->email ?? 'ช่างภาพ'); ?></strong>
  ...
  <?php echo $__env->make('layouts.partials.photographer-sidebar', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
  ...
  <div class="flex flex-col min-h-screen pg-page-bg transition-all duration-300"
    ...
    <div class="px-6 h-[60px] flex items-center sticky top-0 z-[1030] text-white
      ...
      <span class="font-semibold text-white text-base"><?php echo $__env->yieldContent('title', 'Dashboard'); ?></span>
      <div class="ml-auto flex items-center gap-3">
        ...
        <a href="<?php echo e(route('photographer.subscription.index')); ?>"
           ...
           title="<?php echo e(($photographerPlan?->name ?? 'Free')); ?> · จัดการแผน">
          <div class="relative flex items-center justify-center w-9 h-9 rounded-lg bg-white/15 hover:bg-white/25 backdrop-blur-sm border border-white/25 text-white text-base shadow-sm transition">
            <i class="bi <?php echo e($photographerPlanIcon ?? 'bi-camera'); ?>"></i>
            
            <span class="absolute -top-1 -right-1 w-2.5 h-2.5 rounded-full ring-2 ring-white/80 shadow"
                  style="background:<?php echo e($photographerPlanAccent ?? '#7c3aed'); ?>;"></span>
          </div>
          <div class="leading-tight">
            <span class="block text-sm font-semibold text-white"><?php echo e($photographer->display_name ?? Auth::user()?->full_name ?? ''); ?></span>
            <span class="block text-[10px] uppercase tracking-[0.14em] font-bold text-white/75 group-hover:text-white transition">
              <i class="bi <?php echo e($photographerPlanIcon ?? 'bi-camera'); ?> text-[10px] mr-0.5"></i>
              <?php echo e($photographerPlan?->name ?? 'Free'); ?>

            </span>
          </div>
        </a>
        <form method="POST" action="<?php echo e(route('photographer.logout')); ?>" class="inline">
          <?php echo csrf_field(); ?>
    ...
    <main class="p-6">
      ...
      <?php if(auth()->guard()->check()): ?>
        ...
        ?>
        <?php if(!$_pgHasGoogle): ?>
        <div x-data="{ show: !sessionStorage.getItem('pg_google_promo_dismissed_' + <?php echo e(\Illuminate\Support\Facades\Auth::id()); ?>) }"
             x-show="show" x-cloak
          ...
          <div class="relative p-4 flex items-center gap-4 flex-wrap">
            ...
            <div class="flex items-center gap-2 flex-shrink-0">
              <a href="<?php echo e(route('photographer.auth.redirect', ['provider' => 'google'])); ?>"
              ...
              <button type="button"
                      @click="show = false; sessionStorage.setItem('pg_google_promo_dismissed_' + <?php echo e(\Illuminate\Support\Facades\Auth::id()); ?>, '1')"
...
<script>
  IdleLogout.init({
    ...
    logoutUrl: '<?php echo e(route("photographer.logout")); ?>',
    csrfToken: '<?php echo e(csrf_token()); ?>',
    loginUrl: '<?php echo e(route("photographer.login")); ?>',
...
<?php /**PATH C:\xampp\htdocs\photo-gallery-pgsql\resources\views/layouts/photographer.blade.php ENDPATH**/ ?>