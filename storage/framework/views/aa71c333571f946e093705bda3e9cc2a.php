      ...
      <div class="login-body">
        ...
        <?php if(session('logout_success')): ?>
          <div class="rounded-xl p-3 text-sm mb-4 bg-emerald-50 text-emerald-700 border border-emerald-200 dark:bg-emerald-500/10 dark:text-emerald-300 dark:border-emerald-400/30 lanim d1">
            <i class="bi bi-check-circle mr-1"></i><?php echo e(session('logout_success')); ?>
        ...
        <?php if(session('info')): ?>
          <div class="rounded-xl p-3 text-sm mb-4 bg-sky-50 text-sky-700 border border-sky-200 dark:bg-sky-500/10 dark:text-sky-300 dark:border-sky-400/30 lanim d1">
            <i class="bi bi-info-circle mr-1"></i><?php echo e(session('info')); ?>
        ...
        <?php if(session('warning')): ?>
          <div class="rounded-xl p-3 text-sm mb-4 bg-amber-50 text-amber-800 border border-amber-200 dark:bg-amber-500/10 dark:text-amber-300 dark:border-amber-400/30 lanim d1">
            <i class="bi bi-clock-history mr-1"></i><?php echo e(session('warning')); ?>
        ...
        <?php if($errors->any()): ?>
          <div class="rounded-xl p-3 text-sm mb-4 bg-red-50 text-red-700 border border-red-200 dark:bg-red-500/10 dark:text-red-300 dark:border-red-400/30 lanim d1">
            <i class="bi bi-exclamation-circle mr-1"></i><?php echo e($errors->first()); ?>
        ...
        <div class="lanim d1">
          <?php if (isset($component)) { $__componentOriginalbff4465d2e94602ab0e0e4c0479bfedf = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalbff4465d2e94602ab0e0e4c0479bfedf = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.social-buttons','data' => ['role' => 'customer','size' => 'md','intent' => 'login','hideRecommended' => true]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('social-buttons'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['role' => 'customer','size' => 'md','intent' => 'login','hideRecommended' => true]); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginalbff4465d2e94602ab0e0e4c0479bfedf)): ?>
<?php $attributes = $__attributesOriginalbff4465d2e94602ab0e0e4c0479bfedf; ?>
<?php unset($__attributesOriginalbff4465d2e94602ab0e0e4c0479bfedf); ?>
<?php endif; ?>
<?php if (isset($__componentOriginalbff4465d2e94602ab0e0e4c0479bfedf)): ?>
<?php $component = $__componentOriginalbff4465d2e94602ab0e0e4c0479bfedf; ?>
<?php unset($__componentOriginalbff4465d2e94602ab0e0e4c0479bfedf); ?>
<?php endif; ?>
        </div>
        ...
        <?php if($emailReg): ?>
          ...
          <form method="POST" action="<?php echo e(route('auth.login.post')); ?>" class="lanim d3">
            <?php echo csrf_field(); ?>
            <div class="mb-3">
              <label class="block text-sm font-semibold text-gray-700 dark:text-gray-200 mb-1.5" for="login-email">อีเมล</label>
              <div class="input-wrap">
                <i class="bi bi-envelope"></i>
                <input id="login-email" class="fancy-input" type="email" name="email" value="<?php echo e(old('email')); ?>" required autofocus placeholder="example@email.com" autocomplete="email">
              </div>
            </div>
            ...
            <div class="flex items-center justify-between mb-4">
              ...
              <a href="<?php echo e(route('password.request')); ?>" class="text-sm font-semibold text-indigo-600 hover:text-indigo-700 dark:text-indigo-400">ลืมรหัสผ่าน?</a>
            </div>
        ...
        <div class="text-center mt-6 lanim d3 space-y-2">
          <div>
            ...
            <a href="<?php echo e(route('auth.register')); ?>" class="text-sm font-bold text-indigo-600 hover:text-indigo-700 dark:text-indigo-400 ml-1">สมัครสมาชิก</a>
          </div>
          <div>
            <a href="<?php echo e(route('auth.register')); ?>#role-photographer-title"
    ...
    <div class="text-center mt-6 text-xs text-slate-500 dark:text-slate-400 lanim d3">
      ...
      <a href="<?php echo e(url('/help')); ?>" class="hover:underline">ศูนย์ช่วยเหลือ</a>
    </div>
  </div>
</div>
...
(() => {
  ...
  async function refreshCsrf() {
    try {
      const res = await fetch('<?php echo e(route('csrf.refresh')); ?>', {
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\photo-gallery-pgsql\resources\views/public/auth/login.blade.php ENDPATH**/ ?>